    ...
    var buildRow = function (dataIndex, dataId, getFieldValue, dataObject) {
        ...
        $.each(columns, function (k, v) {
                ...
                if (v.type == "img" && v.visible != false) {
                    ...
                    if (v.collect) {
                        ...
                        $(td).css({'max-width':'150px','word-break':'break-all'}).html( showValue);
                    }
                }
        ...
        if (options != null) {
            ...
            $.each(options, function (i, opt) {
                ...
                var a_tag;
                var icon = opt.icon;
                var span=opt.span ==null?'':opt.span+'';
                ...
                a_tag = $("<a class='btn radius6 " +color + flag + "' title='" + title + "' href='javascript:void(0);' style='color: #333;" + fontSize + "'><i class='" + icon + "'></i>" + btnName +span + "</a>");
                if (opt.option != null) {
