...
if (jQuery) {
    ...
    var Shinez = {
        ...
        //查
        get: (url, data, successCallback, failback) => {
            if (typeof(data) == "function") {
                successCallback = data;
                data = {};
            }
            return Shinez.xhr("GET", url, data, true, successCallback, "json", "", failback);
        },
        //删
        ...
        xhr: function (type, url, data, async, successCallback, dataType, contentType, failback) {
            ...
            return $.ajax({
                ...
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    if (failback) {
                        failback(JSON.parse(XMLHttpRequest.responseText));
                    }
                    console.log(XMLHttpRequest.responseText);
                }
            });
